...
$(document).ready(function(){
 ...
 // getStub('/getLanding', function(results){
    var tableString = "<tr><th>Request #</th><th>Course</th><th>Start Date</th><th>End Date</th></tr>";
    ...
    $.each(results, function(index, rowObject){
      tableString += "<tr class='clickable-row'><td>" + rowObject.trng_reqst_nbr + "</td>" +
        ...
        "<td>" + rowObject.trng_cors_strt_dt + "</td><td>" + rowObject.trng_cors_end_dt + "<tr></tr></tr>";
